...
interface ComponentOption {
  ...
  compatible_products_json: unknown[];
...
export function ComponentOptionManager() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          <h3 className="text-lg font-semibold">Opções de Componentes</h3>
      ...
      {error && (
        <Alert variant="destructive">
          <AlertTitle>Erro ao carregar opções</AlertTitle>
              ...
              {options.map((option) => (
                <TableRow key={option.id}>
                  ...
                  <TableCell className="hidden text-xs text-muted-foreground md:table-cell">
                    {option.compatible_products_json?.length ?? 0} produtos
                  </TableCell>
                  <TableCell className="hidden text-xs text-muted-foreground md:table-cell">
          ...
          <Form {...form}>
            <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: Zíper de metal" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: COMP_ZIPER_METAL" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>ID do insumo relacionado</FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                control={form.control}
                name="compatible_products_json"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Produtos compatíveis (JSON)</FormLabel>
                    <FormControl>
                      <Textarea
                ...
                render={({ field }) => (
                  <FormItem className="flex items-center justify-between rounded-lg border p-3">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Opções desativadas ficam ocultas para usuários comuns.
                      </p>
                    </div>
                    <FormControl>
